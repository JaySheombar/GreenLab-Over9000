...
$(function(){
	...
	$(window).on("scroll resize", function () {
		...
		oScrollTimer = setTimeout(function () {
			...
			var iC2PosL = $(".container .r1 .c2").position().left; //父容器的定位
			$(".container .r1 .c2").height($(".container .r1 .c2").find(".inner").height()); //父子容器等高

			if (iWinScrollT > $(".container .r1 .c2").offset().top + $(".container .r1 .c2").height() - $(window).height()) {
				$(".container .r1 .c2 > .inner").css({ "position": "fixed", "left": iC2PosL, "bottom": "0px", "z-index": "50" });
			} else {
...
// 判斷影音廣告，多於3則要移除 (理想：廣告1則+普通2則)=====================
$(function(){
	var $piece =  $(".area_2 .part_thumb_2 .piece");
	var iNum = $(".area_2 .ad_pictxt_1").length; // 要remove的則數
	if( iNum >0 ){
...
$(function(){
	...
	if( $(".block_title.fixed").length > 0){
		...
		//吸住===
		var iPoint = parseInt( $(".block_title.fixed").offset().top + 535 );
		var iWinScrollT;
...
$(function(){
	//初始
	$("#warrant-tab .tab_title a").eq(0).addClass("current");
	
	$("#warrant-tab .tab_title a").click(function(e){
		e.preventDefault();
		var iNo = $(this).index();
		var sWarrantUrl = $(this).data("url");
		$("#warrant-tab iframe#warrant").attr({"src":sWarrantUrl});
		$("#warrant-tab .tab_title a").eq(iNo).addClass("current").siblings().removeClass("current");
	});
});
...
$(function(){
	...
	$(".topbar a").click(function(){
		ga("PCWeb.send", "event", "版頭-Topbar", ""+ $(this).text() +"");
	});
	...
	$(".hot_video .part_pictxt_4 .piece a").click(function(){
		...
		ga("PCWeb.send", "event", "側欄-最夯影音", ""+ videoH +"", "第"+iNo+"則");
	});
	...
	$(".sidebar-hot-express .part_pictxt_6 .piece a").click(function(){
		...
		ga("PCWeb.send", "event", "側欄-熱門快報", "第"+iNo+"則", ""+ sNewsH +"-"+ $(this).attr('href') +"");
	});
	...
	//首頁-大圖
	$(".hot_zone_box .area_1 .piece a.pic img").click(function(){
	   var sImgText = $(this).attr("title");
	   ga("PCWeb.send", "event", "首頁-大圖", ""+ sImgText +"", ""+ $(this).attr('href') +"");
	});
	
	//首頁-頭條快報
	$(".hot_zone_box .area_2 .piece a.pic").click(function(){
	...
	//首頁-影音開框節目表開關
	$("body.index #etnews_live_player .box_2 .slidmenu .videotrack").click(function(){
	   $(this).removeClass("videotrack");
	   var sTitleText = $(this).parents(".box_2").siblings(".box_1").find("#video_title").text();
	   ga("PCWeb.send", "event", "首頁-影音開框節目表開關", ""+ sTitleText +"");	
	});
	...
	//首頁-貼稿區群組-圖
	$("body.index .focus-list .cover_pic").click(function(){
	   ga("PCWeb.send", "event", "首頁-貼稿區群組", ""+ $(this).parent().find('h2').text() +"", ""+ $(this).find('h3').text() +"");
	});	
	
	//首頁-貼稿區群組-標
	$("body.index .focus-list h3 a").click(function(){
	   ga("PCWeb.send", "event", "首頁-貼稿區群組", ""+ $(this).closest('.piece').find('h2').text() +"", ""+ $(this).text() +"");
	});		
	
	//首頁-貼稿區群組-more
	$("body.index .focus-list .btn_more").click(function(){
	   ga("PCWeb.send", "event", "首頁-貼稿區群組", ""+ $(this).closest('.title').find('h2').text() +"", "更多");
	});	

	//首頁-焦點新聞-第一張圖
	$("body.index .focus-news .cover_pic a").click(function(){
	   ga("PCWeb.send", "event", "首頁-焦點新聞", ""+ $(this).find('img').attr('alt') +"", "第1張圖");
	});	
		
	//首頁-焦點新聞-標題
	$("body.index .focus-news h3 a").click(function(){
	   ga("PCWeb.send", "event", "首頁-焦點新聞", ""+ $(this).text() +"", "標題");
	});	
	
	//首頁-焦點新聞-更多
	$("body.index .focus-news .btn_more").click(function(){
	   ga("PCWeb.send", "event", "首頁-焦點新聞", "更多", "");
	});	
	
	//首頁-即時人氣-第一張圖
	$("body.index .realtime-hot .cover_pic a").click(function(){
	   ga("PCWeb.send", "event", "首頁-即時人氣", ""+ $(this).find('img').attr('alt') +"", "第1張圖");
	});	
		
	//首頁-即時人氣-標題
	$("body.index .realtime-hot h3 a").click(function(){
	   ga("PCWeb.send", "event", "首頁-即時人氣", ""+ $(this).text() +"", "標題");
	});	
	
	//首頁-即時人氣-更多
	$("body.index .realtime-hot .btn_more").click(function(){
	   ga("PCWeb.send", "event", "首頁-即時人氣", "更多", "");
	});	
	
	//首頁-大檸檬-圖+文
	$("body.index .lemon a").click(function(){
	...
	$("#hot_area .piece .part_list_3 h3 a").on("click",function(){
		var iCurrentNo = $("#hot_area .piece .part_list_3 h3 a").index($(this))+1;
	...
	$("#et_sticky_pc a.weibo").click(function(){
	  ga("PCWeb.send", "event", "新聞頁-左側社群分享", "Weibo-share",""+self.location.href+"");
	});	
	...
	$("#et_sticky_pc a.gplus").click(function(){
	  ga("PCWeb.send", "event", "新聞頁-左側社群分享", "GooglePlus-share",""+self.location.href+"");
	});	
	...
	//新聞頁-社群分享：Weibo
	$(".part_menu_4 a.weibo").click(function(){
	  ga("PCWeb.send", "event", "新聞頁-文末社群分享", "Weibo-share",""+self.location.href+"");
	});	
	
	//新聞頁-社群分享：Google+
	$(".part_menu_4 a.gplus").click(function(){
	  ga("PCWeb.send", "event", "新聞頁-文末社群分享", "GooglePlus-share",""+self.location.href+"");
	});	
...
$(document).on("click",".et_push_refuse",function(){
    ...
    st = "webpush=" + (Number(ti)+1) +"; expires=" + expires.toGMTString() +"; domain=ettoday.net"
    document.cookie = st;
});
